package com.prmto.translator.android.voice_to_text.presentation
...
import com.prmto.translator.android.voice_to_text.presentation.components.VoiceRecorderDisplay
import com.prmto.translator.voice_to_text.presentation.DisplayState
import com.prmto.translator.voice_to_text.presentation.VoiceToTextEvent
import com.prmto.translator.voice_to_text.presentation.VoiceToTextState
                    ...
                    when (displayState) {
                        ...
                        DisplayState.SPEAKING -> {
                            Log.d(
                                ...
                                "powerRatios  On Screen: ${state.powerRatios}"
                            )
                            VoiceRecorderDisplay(
